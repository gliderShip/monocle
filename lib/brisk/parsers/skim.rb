...
module Brisk
  module Parsers
    module Skim
      ...
      BAD_CLASS = 'div[class="thumb"], div[class*="trendingNow"], div[class="yt-scrollbar"], div[class*="related-posts"], div[class="global-content-right"], [class="side-mod"], [class*="postim-data"], [class*="info-box"], [class*="-author"], [class*="author_info"], [class~="hide"], [class*="expand"], [class*="collapse"], [class*="didascalia"], [class*="date"], [class*="dropdown"], [class*="footer"], [class*="credits"], [class*="prev_"], [class~="skip"], div[class*="comment"], div[class*="Comment"], div[class*="meta"], div[class*="foot"], div[class*="note"], div[class*="noprint"], div[class~="sidebar"], div[class*="widget"], span[class*="postinfo"], [class*="articleinfo"], p[class*="caption"], div[class*="bookmarks"], div[class*="navigation"], div[class*="Navigation"], div[class="banner"], div[class*="breadcrumb"], [class*="sondag"], [class~="menu"]'
      BAD_ID = 'div[id="alerts"], div[id="watch7-container"], td[id*="news_page_text"] div[style*="float"], div[id*="footer"], div[id*="comment"], div[id*="Comment"], div[id*="meta"], div[id~="sidebar"], div[id*="widget"], div[id*="foot"], div[id*="note"], div[id*="noprint"], div[id*="bookmarks"], div[id="banner"]'
      SPACES = 'br'
