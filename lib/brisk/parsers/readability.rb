...
module Brisk
  module Parsers
    module Readability extend self
      ...
      REMOVE_CLASS = '[class*="-meta"], body *[class*="header"], [class*="before"], body *[class*="stats"], [class*="date"], [class*="img"], [class="reader"], [class*="skip"], [class*="tools"], [class*="share"], [class*="history"]'
      REMOVE_ID = '[id*="see-also"], [id*="article-image"], [id*="-meta"], [id*="before"], [id*="stats"], [id*="tools"], [id*="share"]'
