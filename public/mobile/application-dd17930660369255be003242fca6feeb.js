...
(function() {
  ...
  $(function() {
    $('body').touch();
    $('body').on('tapactive', '.tappable', function(e) {
      return $(e.currentTarget).addClass('tappable-active');
    });
    return $('body').on('tapblur', '.tappable', function(e) {
      return $(e.currentTarget).removeClass('tappable-active');
    });
  });
...
this.require.define({"app/controllers/comments":function(exports, require, module){(function() {
  var $, Comments, Controller, Post, State, helpers,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Comments = (function(_super) {
    ...
    Comments.prototype.helpers = helpers;

    Comments.prototype.className = 'comments view';
    ...
    function Comments() {
      ...
      this.on('click', 'header a[href]', this.open);
    ...
    Comments.prototype.render = function() {
      ...
      this.$thread = this.$('section.thread');
      return this.post.comments.all().promise.done(function(comments) {
        return _this.$thread.html(_this.view('comments/items')({
          comments: comments
        }));
      });
    };

    Comments.prototype.setPost = function(post) {
      var _ref;
      if ((_ref = this.post) != null) {
        _ref.unobserve(this.render);
      }
      this.post = post;
      this.post.observe(this.render);
      return this.post.promise.done(this.render);
    };

    Comments.prototype.open = function(e) {
      e.preventDefault();
...
this.require.define({"app/controllers/posts":function(exports, require, module){(function() {
  var $, Controller, Post, Posts, State, helpers,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Posts = (function(_super) {
    ...
    Posts.prototype.helpers = helpers;

    Posts.prototype.className = 'posts view loading';

    function Posts() {
      this.highlight = __bind(this.highlight, this);
      this.tapNext = __bind(this.tapNext, this);
      this.tapMore = __bind(this.tapMore, this);
      ...
      this.collection = Post.popular;
      this.collection.on('add', this.addOne);
      this.collection.fetch().done(this.done);
      this.on('tap', 'a[href]', this.tap);
      this.on('click tap', 'a.more', this.tapMore);
      this.on('click tap', 'a.content', this.tapMore);
      this.on('tap', 'a.next', this.tapNext);
      this.on('tap', '.item', this.highlight);
      this.render();
    }

    Posts.prototype.render = function() {
      this.html(this.view('posts')(this));
      this.$posts = this.$('.posts-list ul');
      return this.addAll();
    };

    Posts.prototype.done = function() {
      return this.$el.removeClass('loading');
    };

    Posts.prototype.addOne = function(post) {
      return this.$posts.append(this.view('posts/item')({
        post: post
      }));
    };

    Posts.prototype.addAll = function() {
      return this.collection.each(this.addOne);
    };

    Posts.prototype.cancel = function(e) {
      return e.preventDefault();
    };

    Posts.prototype.tap = function(e) {
    ...
    Posts.prototype.tapMore = function(e) {
      var $item, post, postID;
      e.preventDefault();
      $item = $(e.currentTarget).closest('.item');
      postID = $item.data('id');
      ...
      return State.toView('comments');
    };

    Posts.prototype.tapNext = function(e) {
      return Post.popular.next();
    };

    Posts.prototype.highlight = function(e) {
      var $item;
...
;}});
this.require.define({"app/controllers/view":function(exports, require, module){(function() {
  var Controller, State, View,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  View = (function(_super) {
    ...
    function View() {
      ...
      this.tapHeader = __bind(this.tapHeader, this);
      this.showAddressBar = __bind(this.showAddressBar, this);
      this.hideAddressBar = __bind(this.hideAddressBar, this);
      View.__super__.constructor.apply(this, arguments);
      this.on('touchstart', '> .scroll', this.hideAddressBar);
      this.on('tap', '> header', this.tapHeader);
      this.on('tap click', '.header-back-button', this.back);
    }

    View.prototype.hideAddressBar = function() {
      return this.trigger('hide.addressbar.app');
    };

    View.prototype.showAddressBar = function() {
      return this.trigger('show.addressbar.app');
    };

    View.prototype.tapHeader = function(e) {
      if (e.target !== e.currentTarget) {
        return;
      }
      if (this.$('> .scroll > section').scrollTop() === 0) {
    ...
    View.prototype.scrollToTop = function() {
      return this.$('> .scroll > section').scrollTop(0);
    };

    View.prototype.back = function() {
      return State.toPreviousView();
    };
...
this.require.define({"app/index":function(exports, require, module){(function() {
  var $, App, Comments, Controller, Post, Posts, Router, Session, State, User,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  App = (function(_super) {
    ...
    App.prototype.className = 'app mobile';
    ...
    function App(options) {
      ...
      this.append(this.comments = new Comments);
      State.set({
        user: options.user && new User(options.user)
      });
      State.on('view', this.setView);
      this.hideAddressBar();
      this.on('hide.addressbar.app', this.hideAddressBar);
      this.on('show.addressbar.app', this.showAddressBar);
      (this.router = new Router).change();
    }

    App.prototype.hideAddressBar = function() {
      $('body').css({
    ...
    App.prototype.showAddressBar = function() {
      return $('body').css({
        height: '100%'
      });
    };

    App.prototype.animation = {
      rtl: ['slide-out-to-left', 'slide-in-from-right'],
      ltr: ['slide-out-to-right', 'slide-in-from-left']
    };

    App.prototype.setView = function(viewName, dir) {
      var animation, done, view,
        _this = this;
      if (viewName == null) {
        viewName = 'posts';
      }
      ...
      if (!(animation = this.animation[dir])) {
        throw new Error("Unknown animation '" + dir + "'");
      }
      if (view.$el.is(this.$current)) {
        return;
      }
      this.$previous = this.$current;
      this.$current = view.$el;
      this.$current.addClass('active');
      if (!this.$previous) {
        return;
      }
      done = function() {
        _this.$previous.removeClass('active');
        _this.$previous.removeClass(animation[0]).removeClass('slide');
        return _this.$current.removeClass(animation[1]).removeClass('slide');
      };
      this.$previous.one('webkitAnimationEnd', done);
      this.$previous.addClass('slide').addClass(animation[0]);
      return this.$current.addClass('slide').addClass(animation[1]);
    };
...
;}});
this.require.define({"app/lib/browser":function(exports, require, module){(function() {
  var iOS5, iPhoneIPod, ua;
...
this.require.define({"app/router":function(exports, require, module){(function() {
  ...
  AppRouter = (function(_super) {
    ...
    function AppRouter() {
      ...
      this.routePosts = __bind(this.routePosts, this);
      this.setView = __bind(this.setView, this);
      AppRouter.__super__.constructor.apply(this, arguments);
      this.add('/', this.routePosts);
      this.add('/posts/:slug', this.routePost);
      State.on('view', this.setView);
    }

    AppRouter.prototype.setView = function(view) {
      var post;
      if (view == null) {
        view = 'posts';
      }
      switch (view) {
        ...
        case 'comments':
          post = State.get('post');
          return post && this.navigate("/posts/" + (post.get('slug')));
      }
    };

    AppRouter.prototype.routePosts = function() {
      return State.toView('posts', 'ltr');
    };
...
this.require.define({"app/state":function(exports, require, module){(function() {
  ...
  State = (function(_super) {
    ...
    function State() {
      this.toPreviousView = __bind(this.toPreviousView, this);
    ...
    State.prototype.toView = function(view, dir) {
      this.previousView = this.view;
      this.view = view;
      return this.trigger('view', this.view, dir);
    };

    State.prototype.toPreviousView = function() {
      this.view = this.previousView;
      console.log(this.view);
      this.previousView = null;
      return this.trigger('view', this.view, 'ltr');
    };
...
(function() { this.JST || (this.JST = {}); this.JST["app/views/comments"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push(__sanitize(this.helpers.pluralize('point', this.post.get('votes'))));
        ...
        __out.push(__sanitize(this.post.get('comments_count')));
      
        __out.push('\n                    ');
      
        __out.push(__sanitize(this.helpers.pluralize('comment', this.post.get('comments_count'))));
      
        __out.push('\n                </span>\n            </div>\n        </header>\n\n        <span class="summary-container">\n            ');
      
        if (this.post.get('oembed') && this.post.get('oembed').src) {
          __out.push('\n                <div class="video-container">\n                <iframe style="visibility:hidden;" onload="this.style.visibility = \'visible\';" class="article-video" src="');
          __out.push(__sanitize(this.post.get('oembed').src));
          __out.push('" frameborder="0" scrolling="no" seamless allowfullscreen="" >\n                </iframe>\n                </div>\n            ');
        } else {
          __out.push('\n                ');
...
(function() { this.JST || (this.JST = {}); this.JST["app/views/comments/item"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push(__sanitize(this.comment.get('parent_id') ? __out.push('child') : void 0));
      
        __out.push('"\n  data-id="');
      
        __out.push(__sanitize(this.comment.get('id')));
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          child = _ref[_i];
          __out.push('\n    ');
          __out.push(this.view('comments/item')({
            comment: child
          }));
          __out.push('\n  ');
        }
...
(function() { this.JST || (this.JST = {}); this.JST["app/views/comments/items"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
...
(function() { this.JST || (this.JST = {}); this.JST["app/views/posts"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<header>\n  <a class="logo landing" href="http://www.albanania.com">albanania</a>\n</header>\n\n<div class="scroll">\n  <section class="posts-list">\n    <ul class="tableview tableview-links">\n    </ul>\n\n    <div class="activity-indicator"></div>\n\n    <div class="item tappable">\n      <a class="next">More…</a>\n    </div>\n  </section>\n</div>\n');
...
(function() { this.JST || (this.JST = {}); this.JST["app/views/posts/item"] = function(__obj) {
    ...
    (function() {
      (function() {
        __out.push('<li class="item tappable" data-id="');
        ...
        if (this.post.get('icon')) {
          ...
          __out.push('\n            <img src="');
          __out.push(__sanitize('/assets/missingal@2x.png'));
          __out.push('" width="70px" height="70px">\n        ');
        }
...
(function() { this.JST || (this.JST = {}); this.JST["app/views/posts/items"] = function(__obj) {
    ...
    (function() {
      (function() {
        ...
        __out.push('<ul class="tableview tableview-links">\n  ');
...
//
// Modules shared between mobile/desktop
